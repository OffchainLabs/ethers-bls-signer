...
describe('Ethers bls signer', () => {
  it('should instantiate signer class', async () => {
    const privateKey = "0xf3c577f834077e65232aefe9439dc0ebe7f0e9f723989b3f61b368707d320d08";
  ...
  it('should sign messages correctly', async () => {
    const privateKey = "0x88f8223131ba22b488e060ae6af60c3a70f8a3b52299b792907672be8e18d314";
    const domain = "0xdffe14e8f78878d1c94ba4a209cfc08b21f23fb83974292cf8b486e315e559b1";
    const signer = await BlsSigner.getBlsSigner(privateKey, domain);
